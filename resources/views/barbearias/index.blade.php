...
<body class="bg-black text-white min-h-screen flex flex-col">
    ...
    <div class="flex-grow">
        <!-- Navbar -->
        <nav
            class="flex flex-col md:flex-row justify-between items-center px-6 py-4 relative z-10 bg-opacity-60 backdrop-filter backdrop-blur-sm  top-0">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="/cadastro"
                    class="bg-[#d19f68] text-black px-4 py-2 rounded-full font-medium hover:bg-[#b88c5a] transition-colors flex items-center gap-1">
        ...
        <section class="relative z-10 py-16 px-6">
            <div class="container mx-auto text-center">
                ...
                <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Agende seu horário com os melhores profissionais
                    da sua região de forma prática e rápida.</p>

                <a href="#barbearias"
                    class="bg-[#d19f68] text-black px-8 py-3 rounded-full font-semibold text-lg hover:bg-[#b88c5a] transition-colors inline-flex items-center gap-2">
        ...
        <main id="barbearias" class="container mx-auto px-4 py-8 relative z-10">
            ...
            <div id="barbearia-list" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($barbearias as $barbearia)
                    <div
                        class="bg-gray-900 rounded-xl overflow-hidden shadow-lg border border-gray-800 hover:border-[#d19f68] transition-all hover-scale">
                        <div class="h-48 bg-cover bg-center"
                            style="background-image: url('{{ $barbearia->imagem_url }}')"></div>
                        <div class="p-6">
                            ...
                            <div class="mt-6">
                                <a href="#"
                                    class="block w-full text-center bg-[#d19f68] text-black font-semibold py-3 rounded-lg hover:bg-[#b88c5a] transition-colors">
                                    Agendar Horário
                                </a>
                            </div>
                        </div>
